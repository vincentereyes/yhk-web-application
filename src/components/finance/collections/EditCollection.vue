    ...
    <div class="edit-collection">
        <ul class="breadcrumbs">
            <div class="container">
                ...
                <li><router-link :to="{ name: 'Collections', params: { phpCollections: phpCollections, usdCollections: usdCollections }}">Filtered Collections</router-link></li>
...
export default {
    name: 'EditCollection',
    props: ['collection', 'phpCollections', 'usdCollections'],
    data() {
        return {
